...
└── assets/
    ├── figuras/             # figuras de datos (EEG + memoria), etiquetas S2/S3
...
- **Clave de scoring:** escala estándar de estadificación — `0=Vigilia, 1=S1, 2=S2, 3=S3, 4=S4`. La columna 1 del `.txt` solo llega al código **3**, por lo que la fase más profunda alcanzada es **S3** (no hay S4 ni REM). Todas las figuras y textos reflejan esto.
